      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            setDeleting(true);
            try {
              await api.delete(`/admin/innovation-comments/${item.id}`);
              onDelete(item.id);
            } catch (e) {
...
export default function InnovationReviewScreen() {
    ...
    <View style={styles.screen}>
      <View style={styles.searchWrapper}>
        <TextInput
          ...
          placeholder="Search comments, users, or innovations..."
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListFooterComponent={
            loadingMore ? <ActivityIndicator color="#465fff" style={{ paddingVertical: 16 }} /> : null
          }
          ListEmptyComponent={
...
const styles = StyleSheet.create({
  ...
  searchWrapper: { paddingHorizontal: 16, paddingTop: 12, paddingBottom: 4, backgroundColor: "#fff", borderBottomWidth: 1, borderBottomColor: "#e4e7ec" },
  searchInput: {
  ...
  avatar: {
    ...
    backgroundColor: "#ecf3ff", alignItems: "center", justifyContent: "center", marginRight: 10,
  },
  avatarText: { fontSize: 16, fontWeight: "700", color: "#465fff" },
  userInfo: { flex: 1 },
